...
- [Image Organize](https://github.com/Sadamdi/image-organize) - Aplikasi desktop Windows untuk mengorganisir foto secara otomatis menggunakan AI dengan deep learning (CLIP)

- [SekitarKampus](https://github.com/Sadamdi/SekitarKampus) - Platform untuk UMKM sekitar kampus, dibangun dengan JavaScript

- [TalentHub](https://github.com/Sadamdi/TalentHub) - Platform talent management, dibangun dengan Dart

- [Deepseek Chat](https://github.com/Sadamdi/deepseek-chat) - Bot Discord AI Assistant dengan DeepSeek AI, dibangun dengan JavaScript

- [APK Resep AI](https://github.com/Sadamdi/APK-Resep-AI) - AI-powered recipe application, dibangun dengan Dart

- [Sadamverse Blog](https://github.com/Sadamdi/Sadamverse-Blog) - Personal blog built using HTML and CSS
